<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">iFern</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i.pinimg.com/736x/45/6c/cd/456ccd90b0aece3274e64fd9922fac63.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Game Developer", "Student"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
...
-webkit-box-shadow: 0px 0px 73px -9px rgba(112, 212, 255, 0.44);
-moz-box-shadow: 0px 0px 73px -9px rgba(112, 214, 255, 0.44);
}
