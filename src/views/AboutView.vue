      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.pinimg.com/736x/45/6c/cd/456ccd90b0aece3274e64fd9922fac63.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Rio Wahyu Fernando. I'm a web developer from Kediri, East Java. I 
            have 4 years of coding experience, and also know a little JavaScript, HTML, CSS. The programming language that I often study is C++.
            I really enjoy what I do right now, in my opinion, creating programs is not just a job, but also an art that
            has
            aesthetic value
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My job is website hosting and GTPS (Growtopia Private Server) hosting.
            In addition, I make sure that the website and gtps server are eye-catching and
            easy to use.
